  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      if (!audioUrl || !imageUrl || !voiceType) {
        toast({
          title: "Audio and Thumbnail cannot blank",
        });
        ...
        >
          ...
          <div className="flex flex-col pt-10">
            ...
            <div className="mt-10 w-full">
              <Button
                type="submit"
                className="text-16 w-full bg-orange-1 py-4 font-extrabold text-white-1 transition-all duration-500 hover:bg-black-1 flex gap-2"
              >
                {isSubmitting ? (
                  <>
                    Submitting
